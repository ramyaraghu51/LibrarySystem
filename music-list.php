...
<body>
															...
															<div class="modal-dialog">
																...
																<div class="modal-content">
																	<div class="modal-header">
																		<a href="music-update.php?id=$row[0]">Update Item </a> 
																		<a href="music-delete.php?id=$row[0]" onclick="deleteItem();">Delete Item </a>
																	</div>
																	<div class="modal-body">
																		<img src="assets/audiobook.png" style="width:40%" class="rounded"> </a> </img>
																		<p>ALBUM TITLE $row[2] <br>
																		  ARTIST:$row[3]<br>
																		  MEDIA TYPE:$row[4] <br>
	...
	<script type="text/javascript">
		...
		function addNewItem() {
			window.location.href = 'music-add.php';
		}
