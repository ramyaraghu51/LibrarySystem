				...
				<div class="container">
									...
									for($j=0; $j<$rows; $j++)
									{
										...
										<div class="row" style="margin-top: 48px;">
											<div class="col-sm-4">
												<img src="assets/film.png" style="width:300px" class="rounded" data-toggle="modal" data-target="#bookinfo$j"> </img>
											</div>
											<div class="col-sm-4">
											<div class="card"  style="height:210px;">
														<div class= "card-body">
												<a href ="film-details.php?id=$row[0]"></a></td>
													Film Name: $row[2] <br>
													Director: $row[3]<br>
															...
															<div class="modal-dialog">
																...
																<div class="modal-content">
																	<div class="modal-header">
																		<a href="film-update.php?id=$row[0]">Update Item </a> 
																		<a href="film-delete.php?id=$row[0]" onclick="deleteItem();">Delete Item </a>
																	</div>
																	<div class="modal-body">
																		<img src="assets/film.png" style="width:40%" class="rounded"> </a> </img>
																		<p> Director: $row[3] <br>
																		  Year_released:$row[4]<br>
																		  Genre:$row[5] <br>
																		  Media Type:$row[6] <br>
	...
	<script type="text/javascript">
		function deleteItem() {
			if (confirm("Do you want to delete this item?")) {
				window.location.href = 'film-list.php';
			}
		}
		...
		function addNewItem() {
			window.location.href = 'film-add.php';
		}
