...
<body>
															...
															<div class="modal-dialog">
																...
																<div class="modal-content">
																	<div class="modal-header">
																		<a href="item-update.php?id=$row[0]">Update Item </a> 
																		<a href="item-delete.php?id=$row[0]" onclick="deleteItem();">Delete Item </a>
																	</div>
																	<div class="modal-body">
																		...
																		<p>Author Name: $row[3] <br>
																		  ...
																		  Media Type:$row[7]</p>
																		<p>$row[8]</p>
																	<div class="modal-footer" data-target="#bookinfo$j">
																		<button type="button" class="btn btn-primary" data-dismiss="modal">Go Back</button>																	
																		<button onclick="addCart($row[1], $userid);" type="button" class="btn btn-primary" data-dismiss="modal">Add to Cart </button>
	...
	<script type="text/javascript">
		...
		function addCart(itemid, userid) {
			...
			window.location.href = 'add-item-cart.php?itemid=' + itemid + '&userid=' + userid;
