				...
				<div class="container">
									...
									for($j=0; $j<$rows; $j++)
									{
										...
										<div class="row" style="margin-top: 48px;">
											<div class="col-sm-4">
												<img src="assets/audiobook.png" style="width:300px" class="rounded" data-toggle="modal" data-target="#bookinfo$j"> </img>
											</div>
											<div class="col-sm-4">
															...
															<div class="modal-dialog">
																...
																<div class="modal-content">
																	<div class="modal-header">
																		<a href="audiobook-update.php?id=$row[0]">Update Item </a> 
																		<a href="audiobook-delete.php?id=$row[0]" onclick="deleteItem();">Delete Item </a>
																	</div>
																	<div class="modal-body">
																		<img src="assets/audiobook.png" style="width:40%" class="rounded"> </a> </img>
																		<p>Author Name: $row[3] <br>
																		  Publisher:$row[4]<br>
																		  Published Date:$row[5] <br>
																		  Genre:$row[6] <br>
																		  Media Type:$row[7]</p>
	...
	<script type="text/javascript">
		function deleteItem() {
			if (confirm("Do you want to delete this item?")) {
				window.location.href = 'audiobook-list.php';
			}
		}
		...
		function addNewItem() {
			window.location.href = 'audiobook-add.php';
		}
