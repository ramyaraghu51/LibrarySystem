                    ...
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            for ($j = 0; $j < $rows; ++$j) {
                                ...
                                echo <<<_END
                                    <form class="card-add-form" action ="film-update.php" method="post">
                                        <div class="form-row justify-content-md-center">
                                            ...
                                            <label for="code">ITEM_CODE</label>
                                                ...
                                                <input type="text" class="form-control" id="publisher" name="director" maxlength="50"  value='$row[3]' style="width:300px;">
                                            
                                                  <label for="value">YEAR RELEASED</label>
                                                <input type="year" class="form-control" id="publish-date" name="year" value='$row[4]' style="width:300px;">
                                        
                                        
                                                <label for="points">Genre</label>
                                                <input type="text" class="form-control" id="type" name="genre" maxlength="50"  value='$row[5]' style="width:300px;">
                                            
                                                <label for="points">Media Type</label>
                                                <input type="text" class="form-control" id="type" name="type" maxlength="50"  value='$row[6]' style="width:300px;">
                        ...
                        if (isset($_POST['Update'])) {
                            ...
                            $query = "UPDATE film set ITEM_CODE='$itemcode',TITLE='$title', DIRECTOR='$dir',YEAR_RELEASED='$year',GENRE='$genre',MEDIA_TYPE='$type'
                             where FILM_ID='$id' ";
